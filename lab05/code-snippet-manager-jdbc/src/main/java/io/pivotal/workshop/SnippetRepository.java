...
public class SnippetRepository {
    ...
    private final String SQL_QUERY_BY_DATE_RANGE = "Select * from snippet where created between ? and ?";

    public List<SnippetRecord> findByDateRange(String start, String end) {
        return jdbcTemplate.query(SQL_QUERY_BY_DATE_RANGE, new Object[]{start, end}, rowMapper);
    }
}
